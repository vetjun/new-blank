...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: w14gK1007wL/css
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___2UZHp)}
                role={"img"}
              />
            ),
      ...
      {true ? (
        <input
          ...
          className={classNames(
            ...
            sty.usernameInput,
            {
              [sty.usernameInput___focusVisibleWithin]:
                triggers.focusVisibleWithin_root,
              [sty.usernameInputcolor_dark]: hasVariant(
                variants,
                "color",
                "dark"
              ),
              [sty.usernameInputisDisabled]: hasVariant(
                variants,
                "isDisabled",
                "isDisabled"
              ),
              [sty.usernameInputshowStartIcon]: hasVariant(
                variants,
                "showStartIcon",
                "showStartIcon"
              )
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bPj2)}
                role={"img"}
              />
            ),
...
const PlasmicDescendants = {
  root: ["root", "startIconContainer", "usernameInput", "endIconContainer"],
